...
document.getElementById('flv_u44').innerHTML=("");

外网串流演示则是 iPhone 搭配小鸡幻蝶分体手柄，内置录屏，所以清晰度比较一般且不支持录制 HDR，实际分辨率和观感要好很多。

document.getElementById('flv_qAa').innerHTML=("");
...
document.getElementById('flv_UNa').innerHTML=("");
...
<blockquote><a href="httphttps://bbs.saraba1st.com/2b/forum.php?mod=redirect&amp;goto=findpost&amp;pid=66935659&amp;ptid=2187742" target="_blank">保科智子 发表于 2024-12-16 10:05</a>
...
<blockquote><a href="httphttps://bbs.saraba1st.com/2b/forum.php?mod=redirect&amp;goto=findpost&amp;pid=66869685&amp;ptid=2187742" target="_blank">bypass 发表于 2024-12-7 22:50</a>

D8P 还算好一点的，我当时买了 D8 拿到手就想扔…虽然价格的确也摆在这就是了。 ...</blockquote>
<img src="https://static.saraba1st.com/image/smiley/face2017/028.png" referrerpolicy="no-referrer">弄了个D9到手就退了，但又看上他家D10和D11了，后者便宜但听说摇杆有十字吸附，主要是能夹大平板就他们加一个，米墨TypeC口夹不了我老ipad
...
<blockquote><a href="httphttps://bbs.saraba1st.com/2b/forum.php?mod=redirect&amp;goto=findpost&amp;pid=67418933&amp;ptid=2187742" target="_blank">afer 发表于 2025-2-14 06:03</a>

说来miniled显示器咋样，我看有个雷鸟的挺便宜</blockquote>
HVA+MINILED肯定比不上OLED

但比IPS强多了
<img src="https://static.saraba1st.com/image/smiley/face2017/067.png" referrerpolicy="no-referrer">顺便已经不常驻HDR了，显示器太热
...
<blockquote><a href="httphttps://bbs.saraba1st.com/2b/forum.php?mod=redirect&amp;goto=findpost&amp;pid=67420689&amp;ptid=2187742" target="_blank">硫黄 发表于 2025-2-14 10:32</a>
就用的雷鸟的

HVA+MINILED肯定比不上OLED

但比IPS强多了</blockquote>
<img src="https://static.saraba1st.com/image/smiley/face2017/019.png" referrerpolicy="no-referrer">买了个鹤6今天才到，突然觉得这么高亮度自己用不到。
...
第二个是今天突然看到这个项目，[https://github.com/Steam-Headless/docker-steam-headless](https://github.com/Steam-Headless/docker-steam-headless)，能够在 Linux 独显环境，在 Docker 容器内运行 Linux DE + Steam 客户端 + Sunshine，刚好我的家庭 PVE 服务器上插着两张卡（一张 4060 Ti 16G PCIe 直连，一张 3060 12G 通过雷电显卡坞连着）但是都是透传给 Debian，刚好看看能不能把其中一台相对闲置的 VM 做一个不下线的串流服务器偶尔连过去玩独立游戏。

折腾了一下，只能说的确能用，但问题也极其多。有两次搞挂我的 VM 就算了，直接把 PVE 也搞死了毕竟硬重启，我跑着一堆服务呢着实遭不住，后面莫名其妙又稍微稳定了一些。自带的虚拟屏幕，玩游戏的时候莫名不走独显，我从箱底翻出来一个 HDMI 欺骗器才恢复正常（暂时只测试了 1080p 60 帧）。即便都是 Linux，可能是 N 卡的缘故，很多游戏没法像 Steam Deck 即开即完，经常需要打开试一下，失败了，再去切换 Proton 版本，有些烦人。

也通过 nvidia-smi 以及显卡坞接的智能插座测了一下功耗，平时不串流，容器跑着的情况，基本跟不开容器差不多功耗（15w 左右，3060 的待机功耗本身就比 4060 Ti 高，后者才 8w 不到），一旦开始串流就会跳到 40w，玩了几个老游戏和独立游戏（如龙 0、再见狂野之心、纪元突变）大概是 50w+，感觉比我预期的低，回头再试试点大型游戏。
